...
public class DataSourceAdvice {
    ...
    private static final String[] defaultSlaveMethodStart = new String[]{ "get", "collect", "has", "query", "is", "find" };
    ...
    public void before(JoinPoint point) {
        ...
        Log.d("切入点: " + point.getTarget().getClass().getName() + "类中" +point.getSignature().getName() + "方法");
