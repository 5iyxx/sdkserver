        ...
        implements ServletRequestAware, SessionAware, ServletResponseAware
{
    ...
    public TreeMap<String,String> getParamTreeMap(){
        Enumeration<String> em = this.request.getParameterNames();
        TreeMap<String,String> treeMap = new TreeMap<>();
        while (em.hasMoreElements()) {
            String paramName = new String(em.nextElement());
            String paramValue = new String(this.request.getParameter(paramName));
